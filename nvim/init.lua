...
vim.api.nvim_set_keymap('n', '<leader>t', [[<cmd>lua require('telescope.builtin').builtin()<CR>]], { noremap = true, silent = true })
...
map("n", "pd", "<cmd>lua vim.lsp.diagnostic.goto_prev { wrap = false }<CR>")
map("n", "nd", "<cmd>lua vim.lsp.diagnostic.goto_next { wrap = false }<CR>")
